...
import co.com.avvillaspasivos.dataconnect.KDbConnect;
...
public class KDbQuerys {
  ...
  public void execQueryGeneric(String param, String sqlQuery) {
    connection = KDbConnect.getConnectionToOracle();
  ...
  public String getXmlOtp(String phone) {
    ...
    try {
      ...
      KDbConnect.closeConnection(connection);
    }
    return xmlResponse;
  }
